...
namespace AppleApp.Controllers
{
    public class BanksController : Controller
    {
        ...
        public BanksController(AppleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Cid,Cname,Balance")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cid,Cname,Balance")] Bank bank)
        {
            if (id != bank.Cid)
            {
                return NotFound();
